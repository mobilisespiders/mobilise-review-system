                                    ...
                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%; border-collapse: collapse;">
                                        ...
                                        <tr>
                                            <td style="color: #4a5568; font-size: 14px; line-height: 22px; padding: 0 0 24px 0;">
                                                You are requested to provide your feedback for the following team members for <b>August and September</b> using these links:
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 24px 0 0 0; color: #4a5568; font-size: 14px; line-height: 22px;">
                                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%; border-collapse: collapse;">
                                                    ...
                                                    <tr>
                                                        <td style="padding: 0 0 12px 0; color: #4a5568; font-size: 14px; line-height: 22px;">Your input is valuable and will remain confidential. Please ensure it is submitted by the end of the day on <strong>25 September 2026</strong>.</td>
                                                    </tr>
                                                    <tr>
